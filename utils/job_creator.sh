...
num_iters="100"
random_seed="0"
config="../exp_configs/lunarlander/config.yaml"
op_path="../log_dirs/lunarlander/"
...
cd ..
cd experiments/
python -u  experiment.py --exp_name ${exp} --datapath ${datapath} --config ${config} --op_path ${op_path} --random_seed ${random_seed}  
"> $job_file
